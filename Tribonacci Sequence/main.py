...
print(tribonacci([1, 1, 1], 10))  # should return [1, 1, 1, 3, 5, 9, 17, 31, 57, 105]
print(tribonacci([0, 0, 1], 10))  # should return [0, 0, 1, 1, 2, 4, 7, 13, 24, 44]
print(tribonacci([0, 1, 1], 10))  # should return [0, 1, 1, 2, 4, 7, 13, 24, 44, 81]
print(tribonacci([1, 1, 1], 1))  # should return [1]
print(tribonacci([300, 200, 100], 0))  # should return []
